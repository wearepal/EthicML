...
INPROCESS_TESTS = [
    ...
    InprocessTest(name="HGR", model=Hgr(dir=TMPDIR, model_type="linear_model"), num_pos=57),
    InprocessTest(name="HGR", model=Hgr(dir=TMPDIR, model_type="deep_model"), num_pos=38),
