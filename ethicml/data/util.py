...
def get_discrete_features(all_feats: List[str], feats_to_remove: List[str],
                          cont_feats: List[str]) -> List[str]:
    return [item for item in filter_features_by_prefixes(all_feats, feats_to_remove)
