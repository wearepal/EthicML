...
def domain_split(
    ...
    train_datatup = DataTuple.from_x_s_and_y(x=train_x, s=train_s, y=train_y, name=datatup.name)
    ...
    test_datatup = DataTuple.from_x_s_and_y(x=test_x, s=test_s, y=test_y, name=datatup.name)
