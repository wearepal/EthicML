...
def empty(shape: _ShapeType, dtype: _DtypeType = float, order: str = ...) -> ndarray: ...
def empty_like(
    a: Any, dtype: Optional[Any] = ..., order: str = ..., subok: bool = ...
) -> ndarray: ...
def eye(N: int, M: Optional[int] = ..., k: int = ..., dtype: _DtypeType = float) -> ndarray: ...
def full(
...
def fromstring(
    string: str, dtype: _DtypeType = float, count: int = ..., sep: str = ...
) -> ndarray: ...
...
def zeros(shape: _ShapeType, dtype: _DtypeType = float, order: str = ...) -> ndarray: ...
def zeros_like(
    a: Any, dtype: Optional[_DtypeType] = ..., order: str = ..., subok: bool = ...
) -> ndarray: ...
...
#
class matrix:
    def __init__(self, data: Union[List, str], dtype: _DtypeType = float, copy: bool = ...): ...
